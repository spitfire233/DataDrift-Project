...
D'altro canto, il coefficiente $R^2$ calcolato per zoom\_blur indica che la degradazione delle performance cresce linearmente con il livello di severity, indicando una correlazione tra degradazione e severità per questo tipo di sporcatura.
\subsubsection{Digital}
\begin{table}[htbp]
\centering
